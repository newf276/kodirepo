...
class Guiwiz(pyxbmct.AddonDialogWindow):
	...
	def main_buttons(self):
		self.BuildsButton= pyxbmct.Button('[COLOR %s][B]Team Asgard[/B][/COLOR]' % MAIN_BUTTONS_TEXT, focusTexture=FBUTTON,noFocusTexture=BUTTON)
		self.placeControl(self.BuildsButton,-2 , 1 , 13, 8)
		self.connect(self.BuildsButton, lambda: self.BuildList())

		self.MaintButton = pyxbmct.Button('[COLOR %s][B]Cleaning Tools[/B][/COLOR]' % MAIN_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
		...
		self.ToolsButton = pyxbmct.Button('[COLOR %s][B]Advance Tools[/B][/COLOR]' % MAIN_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
		...
		self.CloseButton = pyxbmct.Button('[COLOR %s][B]Exit[/B][/COLOR]' % MAIN_BUTTONS_TEXT,focusTexture=EXIT,noFocusTexture=BUTTON)
	...
	def BuildList(self):
		...
		if not BUILDFILE == 'http://' and not BUILDFILE == '':
			...
			InstallButton = pyxbmct.Button('[COLOR %s][B]Standard Install[/B][/COLOR]' % OTHER_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
			self.placeControl(InstallButton,28 , 20, 8, 8)
			self.connect(InstallButton, lambda: buildWizard(Bname,'normal'))
		
			FreshStartButton = pyxbmct.Button('[COLOR %s][B]Clean Install[/B][/COLOR]' % OTHER_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
