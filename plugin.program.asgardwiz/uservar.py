...
ADDONTITLE     = '[COLOR goldenrod]-[B]Team Asgard[/B]-[/COLOR]'
BUILDERNAME    = 'Team Asgard Wiz'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'roms', 'My_Builds', 'backupdir', 'script.module.kodi-six', 'script.module.six']
BUILDFILE      = 'https://mylostsoulspace.co.uk/buildstxt/Buillds.txt'
UPDATECHECK    = 0
APKFILE        = 'http://'
...
#Top Main buttons
MAIN_BUTTONS_TEXT = 'goldenrod'
#All other buttons
OTHER_BUTTONS_TEXT = 'goldenrod'
#all list text color
...
DES_T_COLOR = 'goldenrod'
#Description color
DESCOLOR = 'goldenrod'

#Wizard title name and verion color
WIZTITLE = 'Team Asgard'
WIZTITLE_COLOR = 'goldenrod'
VERTITLE_COLOR = 'goldenrod'
VER_NUMBER_COLOR = 'goldenrod'
############################################################
