...
class SourceSorter:
    ...
    def sort_sources(self, sources_list):
        """Takes in a list of sources and filters and sorts them according to Popcorn's sort settings
    ...
    def _get_sort_methods(self):
        """
        Get Popcorn settings for sort methods
        """
        sort_methods = []
    ...
    def _get_type_sort_order(self):
        """
        Get popcorn settings for type sort priority
        """
        type_priorities = {}
    ...
    def _get_debrid_sort_order(self):
        """
        Get popcorn settings for debrid sort priority
        """
        debrid_priorities = {}
