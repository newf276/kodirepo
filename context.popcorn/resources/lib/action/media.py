...
from resources.lib.action import POPCORN_ADDON_ID
...
class SourceSelect(ContextMediaAction):
    ...
    def handle_path(self):
        ...
        if self.popcorn_reload == "true":
            args['popcorn_reload'] = "true"
        if self.source_select == "true":
            args['source_select'] = "true"

        self.action_path = f"plugin://{POPCORN_ADDON_ID}/?{urlencode(args, quote_via=quote)}"
