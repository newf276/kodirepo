...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing [COLOR deepskyblue][B]Newfs[/B][/COLOR] Wizard.'
...
REPOZIPURL = 'https://github.com/newf276/kodirepo/blob/master/zips/repository.newf/repository.newf-1.4.4.zip?raw=true'
