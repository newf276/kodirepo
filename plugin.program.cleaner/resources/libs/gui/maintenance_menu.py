...
class MaintenanceMenu:
    ...
    def get_listing(self):
        directory.add_dir('[B][COLOR deepskyblue]Cleaning Tools[/B][/COLOR]', {'mode': 'maint', 'name': 'clean'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME1)
    ...
    def clean_menu(self):
        ...
        directory.add_file(
            '[COLOR deepskyblue]Total Clean Up:[/COLOR] [B]{0}[/B]'.format(tools.convert_size(totalsize)), {'mode': 'fullclean'},
            icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('Clear Cache: [B]{0}[/B]'.format(tools.convert_size(sizecache)),
        ...
        directory.add_file('Clear Packages: [B]{0}[/B]'.format(tools.convert_size(sizepack)),
                           {'mode': 'clearpackages'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file(
            'Clear Thumbnails: [B]{0}[/B]'.format(tools.convert_size(sizethumb)),
            {'mode': 'clearthumb'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        if os.path.exists(CONFIG.ARCHIVE_CACHE):
            directory.add_file('Clear Archive_Cache: [B]{0}[/B]'.format(
        ...
        directory.add_file('[COLOR red]Fresh Start[/COLOR]', {'mode': 'freshstart'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        ...
        if autoclean == 'true':
            directory.add_file(
                '--- Auto Clean Frequency: [B]{0}[/B]'.format(
    ...
    def logging_menu(self):
        ...
        wizlogsize = ': Not Found' if not os.path.exists(
            CONFIG.WIZLOG) else ": {0}".format(
        ...
        directory.add_file('View Errors in Log: [B]{0}[/B]'.format(errorsfound), {'mode': 'viewerrorlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        if errors > 0:
        ...
        directory.add_file('Clear Wizard Log File: [B]{0}[/B]'.format(wizlogsize), {'mode': 'clearwizlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
    ...
    def misc_menu(self):
        ...
        directory.add_file('[COLOR yellow]Force Close Kodi[/COLOR]', {'mode': 'forceclose'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
