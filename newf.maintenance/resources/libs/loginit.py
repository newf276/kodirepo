...
ORDER = ['easynews-fenlight',
         ...
         'login-eis', 'tmdb-gaia',
         'tmdb-exodusredux', 'tmdb-fenlight', 'tmdb-metadatautils', 'tmdb-numbers',
...
LOGINID = {
    ...
    'tmdb-fenlight': {
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fenlight_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fenlightlight', 'settings.xml'),
        'default'  : 'tmdb_api',
        'data'     : ['tmdb_api'],
        'activate' : ''},
    'easynews-fenlight': {
        'name'     : 'EasyNews - Fenlight',
        'saved'    : 'easynews-fenlight',
        'plugin'   : 'plugin.video.fenlightlight',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'fanart.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fenlight_easynews'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fenlightlight', 'settings.xml'),
    ...
    'furk-fenlight': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'fanart.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fenlight_furk'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fenlightlight', 'settings.xml'),
        'default'  : 'furk_login',
