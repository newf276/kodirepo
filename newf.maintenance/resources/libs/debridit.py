...
ORDER = ['fenlightad', 'fenlightpm', 'fenlightrd',
...
DEBRIDID = {
    ...
    'fenlightrd': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'fenlight_rd'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.fenlightlight/?mode=real_debrid.authenticate)'},
    'fenlightpm': {
        'name'     : 'Fenlight PM',
        'plugin'   : 'plugin.video.fenlightlight',
        'saved'    : 'fenlightpm',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'fenlight_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fenlightlight', 'settings.xml'),
        'default'  : 'pm.account_id',
        'data'     : ['pm.account_id', 'pm.token'],
        'activate' : 'RunPlugin(plugin://plugin.video.fenlightlight/?mode=premiumize.authenticate)'},
    'fenlightad': {
        'name'     : 'Fenlight AD',
        'plugin'   : 'plugin.video.fenlightlight',
        'saved'    : 'fenlightad',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fenlightlight', 'fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'fenlight_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fenlightlight', 'settings.xml'),
        'default'  : 'ad.account_id',
        'data'     : ['ad.account_id', 'ad.token'],
        'activate' : 'RunPlugin(plugin://plugin.video.fenlightlight/?mode=alldebrid.authenticate)'},
    'shadowrd': {
        'name'     : 'Shadow RD',
