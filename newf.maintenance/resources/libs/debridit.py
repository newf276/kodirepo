...
DEBRIDID = {
    ...
    'fenrd': {
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.newf/?mode=real_debrid.authenticate)'},
    'fenpm': {
        'name'     : 'Newf PM',
        'plugin'   : 'plugin.video.newf',
        'saved'    : 'fenpm',
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.newf/?mode=premiumize.authenticate)'},
    'fenad': {
        'name'     : 'Newf AD',
        'plugin'   : 'plugin.video.newf',
        'saved'    : 'fenad',
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.newf/?mode=alldebrid.authenticate)'},
    'shadowrd': {
        'name'     : 'Shadow RD',
